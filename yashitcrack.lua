...
loadstring(game:HttpGet("https://raw.githubusercontent.com/coolboy12321/a/main/yashitcrack.lua"))() return
...
holder.ChildAdded:Connect(function(v)
    if v.Name:find("Obsidian") or v.Name:find("Vortex") then
        v.Name = v.Name:gsub("Obsidian", "Vortex")
        v.DescendantAdded:Connect(function(v1)
            if v1.ClassName == "TextLabel" or v1.ClassName == "TextButton" or v1.ClassName == "TextBox" then
                v1:GetPropertyChangedSignal("Text"):Connect(function()
                    ...
                    if txt:find("discord.gg") or txt:find("rivalscomp") or txt:find("/yabu") or txt:find("yabujin") or txt:find("yabu") or txt:find("obsidian") then
                        v1.Text = v1.Text:gsub("[Yy][Aa][Bb][Uu][Jj][Ii][Nn]", "Vortex")
                                       :gsub("[Yy][Aa][Bb][Uu]", "Vortex")
                                       :gsub("Rivalscomp", "Vortex")
                                       :gsub("rivalscomp", "Vortex")
                                       :gsub("Obsidian", "Vortex")
                                       :gsub("obsidian", "Vortex")
                                       :gsub("discord.gg/rivalscomp", "discord.gg/gTReXgA9Jq")
                                       :gsub("discord.gg/yabujin", "discord.gg/gTReXgA9Jq")
                    end
                end)
            end
